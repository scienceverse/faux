...
test_that("subset", {
  ...
  labels <- get_labs(p2)
  expect_equal(labels$x, "W1")
  expect_equal(labels$fill, "W2")
  expect_equal(labels$colour, "W2")
...
test_that("2w*2w*2b", {
  ...
  expect_true(is_ggplot(p))
  labels <- get_labs(p)
  expect_equal(labels$x, "condition")
  expect_equal(labels$y, "value")
  expect_equal(labels$fill, "time")
  expect_equal(labels$colour, "time")
})
...
test_that("2w*2w*2b*2b", {
  ...
  expect_equal(labels$x, "condition")
  expect_equal(labels$y, "value")
  expect_equal(labels$fill, "pet")
  expect_equal(labels$colour, "pet")
})
...
test_that("vardesc", {
  ...
  labels <- get_labs(p)
  expect_equal(labels$x, vardesc[["B"]])
  expect_equal(labels$colour, vardesc[["W"]])
  expect_equal(labels$fill, vardesc[["W"]])
  ...
  labels <- get_labs(p)
  expect_equal(labels$x, vardesc[["B"]])
  expect_equal(labels$colour, vardesc[["A"]])
  expect_equal(labels$fill, vardesc[["A"]])
