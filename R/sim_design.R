...
#'
#' Generates a data table with a specified within and between design. See \href{https://www.scienceverse.org/faux/articles/sim_design.html}{\code{vignette("sim_design", package = "faux")}} for examples and details.
#'
